import traceback
from googledataprocauthenticator.sparkmagic.utils.constants import EXPECTED_ERROR_MSG, INTERNAL_ERROR_MSG
...
def handle_expected_exceptions(f):
    ...
    def fn(self, ...):
        etc..."""
    from googledataprocauthenticator.sparkmagic.utils import configuration as conf
