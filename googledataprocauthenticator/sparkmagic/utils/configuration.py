...
def authenticators():
    return  {
        u"Kerberos": u"googledataprocauthenticator.sparkmagic.auth.kerberos.Kerberos",
        u"None": u"googledataprocauthenticator.sparkmagic.auth.customauth.Authenticator",
        u"Basic_Access": u"googledataprocauthenticator.sparkmagic.auth.basic.Basic"
    }
