...
from googledataprocauthenticator.sparkmagic.livyclientlib.exceptions import BadUserDataException, DataFrameParseException, \
...
def initialize_auth(args):
    ...
    Raises:
        googledataprocauthenticator.sparkmagic.livyclientlib.BadUserConfigurationException: if args.auth is not a valid
        authenticator class. 
    """
