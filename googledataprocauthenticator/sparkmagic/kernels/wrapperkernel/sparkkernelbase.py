...
from googledataprocauthenticator.sparkmagic.livyclientlib.exceptions import wrap_unexpected_exceptions
from googledataprocauthenticator.sparkmagic.kernels.wrapperkernel.usercodeparser import UserCodeParser
...
class SparkKernelBase(IPythonKernel):
    ...
    def _load_magics_extension(self):
        register_magics_code = "%load_ext googledataprocauthenticator.sparkmagic.kernels"
    ...
    def _register_auto_viz(self):
        from googledataprocauthenticator.sparkmagic.utils.sparkevents import get_spark_events_handler
